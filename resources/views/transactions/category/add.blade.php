        ...
        <div class="col-xl-8 col-lg-12">
            <div class="card rounded shadow-sm" style="min-height: 350px;">
                <div class="card-body">
                    ...
                    <form action="{{ route('transactions.category.store') }}" method="POST" class="d-flex flex-column py-2">
                        @csrf

                        <div class="form-group mb-3">
                            <label for="name">{{ __('Nama') }}</label>
                            <input type="text" class="form-control" id="name" name="name"
                                value="{{ old('name') }}" required placeholder="Nama kategori">
                        </div>
                        ...
                        <div class="py-3">
                            <button type="submit" class="btn btn-danger btn-md rounded w-100">{{ __('Simpan') }}</button>
                        </div>
